...
public class Org implements Serializable {
	...
	@GenericGenerator(name = "system-uuid", strategy = "assigned") // assigned
	@Column(name="ORG_ID")
	private String id;
	/**
	 * 机构唯一标识
	...
	@Transient
	private String topSubjectPid;
	
	
	
	public String getTopSubjectPid() {
		return topSubjectPid;
	}
	public void setTopSubjectPid(String topSubjectPid) {
		this.topSubjectPid = topSubjectPid;
	}
